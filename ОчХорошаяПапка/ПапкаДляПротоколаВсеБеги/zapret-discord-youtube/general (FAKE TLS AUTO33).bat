...
--filter-tcp=25565 --dpi-desync-any-protocol=1 --dpi-desync=fake,disorder2 --dpi-desync-fooling=badseq --dpi-desync-repeats=8 --dpi-desync-fake-unknown="%BIN%tls_clienthello_www_google_com.bin"
